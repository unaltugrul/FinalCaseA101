...
public class TestCase1 extends TestBase {
    ...
    public void testone() throws InterruptedException {
        ...
        logLog.info("Test Execution is working... Feature - User adds product to cart by logging in...");

        logLog.info("Step 1-User hovers over \"Giris Yap veya uye ol\" button");
        ...
        logLog.info("Step 2-User clicks to \"Giris Yap\" option from opened dropdown menu");
        homePage.girisYapOption.click();

        //3-User enters email address to input box
        logLog.info("Step 3-User enters email address to input box");
        ...
        logLog.info("Step 4-User enters password to input box");
        loginPage.passwordInputBox.sendKeys("Qwerty_123" + Keys.ENTER);

        //5-Verify that user is able to log in successfully
        logLog.info("Step 5-Verifying... that user is able to log in successfully");
        ...
        if (exceptedText.equals(actualText)) {
            logLog.info("PASSED - User logged in successfully");
        } else {
            logLog.error("FAILED - User couldn't log in successfully");
        }
        ...
        logLog.info("Step 6-User enters product name to search box and press enter key");
        ...
        logLog.info("Step 7-User selects the product");
        productListPage.productLink.click();

        //8-User adds product from two different seller
        logLog.info("Step 8-User adds product from two different seller");
        ...
        logLog.info("Step 9-User clicks \"sepete git\" button");
        ...
        logLog.info("Step 10-Verify that correct product has been added correctly to cart");
